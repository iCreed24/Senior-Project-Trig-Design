...
object FloatingPointDesigns2 {
  ...
  class FP_adder_13ccs(bw: Int) extends Module {
    ...
    val exp_diff_subtractor = Module(new BinaryDesigns2.full_subtractor(exponent))
    ...
    val frac_adder = Module(new BinaryDesigns2.full_adder(mantissa + 1))
    ...
    val postProcess_exp_diff_subtractor = Module(new BinaryDesigns2.full_subtractor(exponent))
